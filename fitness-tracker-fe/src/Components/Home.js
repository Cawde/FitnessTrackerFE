        ...
        <div className="Home_content">
          ...
          <div className="Create-routine">
            <form className="create_routine">
              ...
              <button className="Submit_Button" type="submit" onClick={createRoutine}>Create Routine</button>
            </form>
        ...
        <div className="Home_content">
          ...
          <div className="Create-Activity">
            <form className="create_activity">
              ...
              <button className="Submit_Button" type="submit" onClick={createActivity}>Create Activity</button>
            </form>
          </div>
